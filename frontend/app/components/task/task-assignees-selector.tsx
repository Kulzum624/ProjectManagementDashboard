  ...
  return (
    <div className="mb-6">
      ...
      <div className="relative">
        <button
          className="text-sm text-muted-foreground w-full border rounded px-3 py-2 text-left bg-background"
        ...
        {dropDownOpen && (
          <div className="absolute z-10 mt-1 w-full bg-card border rounded shadow-lg max-h-60 overflow-y-auto">
